angular.module('starter')
  .factory('MessageService', ['$rootScope', '$q', 'Pubnub', 'currentUser', 'ngNotify', 'teamFactory',
    function MessageServiceFactory($rootScope, $q, Pubnub, currentUser, ngNotify, teamFactory) {

        // Aliasing this by self so we can access to this trough self in the inner functions
        var self = this;
        this.messages = []
        this.channel = teamFactory.getTeam();
        ...
        var initA = function () {
            self.channel = teamFactory.getTeam();
            self.messages = [];
        ...
        var initContact = function () {   
            self.channel = teamFactory.getContact();
            self.messages = [];
            this.channel = teamFactory.getContact();
        ...
        var sendMessage = function (messageContent) {
            ...
            Pubnub.publish({
                ...
                message: {
                    ...
                    sender_uuid: teamFactory.getUserName(),//currentUser,
                    date: Date.now()
                },
            });
        }
